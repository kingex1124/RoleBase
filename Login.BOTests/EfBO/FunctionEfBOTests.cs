...
namespace Login.BO.Tests
{
    ...
    public class FunctionEfBOTests
    {
        ...
        public void GetFunctionDataTest()
        {
            ...
            _functionEfRepo.Stub(o => o.GetFunctionCount(pageDataVO)).Return(renumber);

            _functionEfRepo.Stub(o => o.GetFunctionData(pageDataVO)).Return(reFunctionDTO);
        ...
        public void GetFunctionToNodeTest()
        {
            ...
            _functionEfRepo.Stub(o => o.GetMenuData(Arg<string>.Is.Anything)).Return(reFunctionDTO);
